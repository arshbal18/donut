<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="DonutShop.Register" %>
...
<body>
    <form id="form1" runat="server">
        <div>
             <div id="login">
        <h1 class="text-center text-black pt-5">Donut Shop</h1>
                         <h3 class="text-center text-black pt-5">Register Here</h3>
        ...
        <br />
                            <asp:Label ID="Label2" runat="server" Text="Phone"  Font-Size="Medium" ForeColor="black"></asp:Label>
       
            <br />
       
            <asp:TextBox class="form-control" ID="Donutmobile" runat="server"   BorderStyle="None" Height="20px" Width="124px"></asp:TextBox>
